# Blueprint that gets registered with Flask app
...
assets_blueprint = Blueprint(
    "assets_blueprint",
    __name__,
    static_folder="assets_compiled/bundled", # Tells Flask path to static assets
    static_url_path="/assets/bundled", # Bundled asset path defined in Vite config
)
